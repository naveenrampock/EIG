  ...
  getEmrCcdExportList() {
    ...
    this.emrservice.getExportCcdDetails(params)
      .subscribe(exportCcdLists => {
        ...
        this.Immunization = this.emrExportToCCDList.Immunization;
        this.Device = this.emrExportToCCDList.Device;
        this.Allergy = this.emrExportToCCDList.Allergy;
        this.Encounters = this.emrExportToCCDList.Encounter;
        this.Procedure = this.emrExportToCCDList.Procedure;
