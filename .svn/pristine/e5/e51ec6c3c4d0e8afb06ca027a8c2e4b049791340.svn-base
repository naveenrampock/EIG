...
@Component({
  selector: 'app-ccr-details',
  templateUrl: './ccr-details.component.html',
  styleUrls: ['./ccr-details.component.css']
})
export class CcrDetailsComponent implements OnInit {
  @Input() ccrDetails: any;
